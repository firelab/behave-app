...
digraph GitHub {
    ...
    DomainUnits [label="Domain-Units
            |{ :bp/uuid                        | string }
            |{ :domain-units/decimals          | string }
            |{ :domain-units/native-unit-uuid  | string }
            |{ :domain-units/english-unit-uuid | string }
            |{ :domain-units/metric-unit-uuid  | string }
            "]
    ...
    Domain -> Domain            [label=":domain/subdomain-uuid" taillabel=1 headlabel=1]
    Domain -> DomainUnits       [label=":domain/domain-units-uuid" taillabel=1 headlabel=1]
    DomainUnits -> Dimension    [label=":domain-units/dimension-uuid" taillabel=1 headlabel=1]
}
#+end_src
