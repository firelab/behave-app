...
(defn ->group-variable
  ...
  (let [payload (if (spec/valid? :behave/group-variable params)
                  ...
                  (cond-> {}
                    ...
                    translation-key                                 (assoc :group-variable/result-translation-key (-> translation-key (s/replace ":input:" ":input:result:") (s/replace ":output:" ":output:result:")))
...
(defn ->group
  ...
  (let [payload (if (spec/valid? :behave/group params)
                  ...
                  (cond-> {}
                    ...
                    translation-key          (assoc :group/result-translation-key (-> translation-key (s/replace ":input:" ":input:result:") (s/replace ":output:" ":output:result:")))
