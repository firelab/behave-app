(ns absurder-sql.datascript.pprint
  (:require
...
(defmethod pp/simple-dispatch Datom [^Datom d]
  (pp/pprint-logical-block :prefix "#absurder-sql.datascript/Datom [" :suffix "]"
    (pp/write-out (.-e d))
...
(defn- pp-db [db ^java.io.Writer w]
  (pp/pprint-logical-block :prefix "#absurder-sql.datascript/DB {" :suffix "}"
