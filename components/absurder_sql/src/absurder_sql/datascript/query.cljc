(ns ^:no-doc absurder-sql.datascript.query
  (:require
    [#?(:cljs cljs.reader :clj clojure.edn) :as edn]
    [clojure.set :as set]
    [clojure.string :as str]
    [clojure.walk :as walk]
    [absurder-sql.datascript.built-ins :as built-ins]
    [absurder-sql.datascript.db :as db]
    [me.tonsky.persistent-sorted-set.arrays :as da]
    [absurder-sql.datascript.lru :as lru]
    [absurder-sql.datascript.impl.entity :as de]
    [absurder-sql.datascript.parser :as dp #?@(:cljs [:refer [BindColl BindIgnore BindScalar BindTuple Constant
                                                             FindColl FindRel FindScalar FindTuple PlainSymbol
                                                             RulesVar SrcVar Variable]])]
    [absurder-sql.datascript.pull-api :as dpa]
    [absurder-sql.datascript.util :as util])
  #?(:clj
     (:import
       [clojure.lang ILookup LazilyPersistentVector]
       [absurder-sql.datascript.parser BindColl BindIgnore BindScalar BindTuple
