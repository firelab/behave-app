Feature: Surface Only Output Selection Conditionals
  ...
  Scenario: Spread Distance is Selected
    ...
    Then the following input Submodule > Groups are displayed:
      ...
      # Given I have started a new Surface Worksheet
      ...
      # Given I have started a new Surface and Crown Worksheet
      ...
      # Given I have started a new Surface and Contain Worksheet
      ...
      # Given I have started a new Surface and Mortality Worksheet
