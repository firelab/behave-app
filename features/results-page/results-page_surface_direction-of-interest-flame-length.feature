@core
Feature: Surface Results - Direction of Interest Flame Length

  @core
  Scenario: Direction of Interest Flame Length is displayed in results when inputs are set
    ...
    Then "the following outputs are displayed in the results page"
      | output                             |
      | Direction of Interest Flame Length |