@core
Feature: Surface Results - Direction of Interest Rate of Spread

  @core
  Scenario: Direction of Interest Rate of Spread is displayed in results when inputs are set
    ...
    Then "the following outputs are displayed in the results page"
      | output                               |
      | Direction of Interest Rate of Spread |