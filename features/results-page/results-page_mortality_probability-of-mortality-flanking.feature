@core
Feature: Mortality Results - Probability of Mortality Flanking

  @core
  Scenario: Probability of Mortality Flanking is displayed in results when inputs are set
    ...
    Then "the following outputs are displayed in the results page"
      | output                            |
      | Probability of Mortality Flanking |