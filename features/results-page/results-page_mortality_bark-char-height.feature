...
Feature: Mortality Results - Bark Char Height
  ...
  @extended
  Scenario Outline: Bark Char Height is displayed in results when inputs are set (Extended) — Group 1
    Given I have started a new Surface & Mortality Worksheet in Guided Mode
    When these output paths are selected
      | submodule     | group          | value          |
      | Fire Behavior | Direction Mode | Heading        |
  ...
  @extended
  Scenario Outline: Bark Char Height is displayed in results when inputs are set (Extended) — Group 2
    Given I have started a new Surface & Mortality Worksheet in Guided Mode
    When these output paths are selected
      | submodule     | group          | value          |
      | Fire Behavior | Direction Mode | Heading        |
