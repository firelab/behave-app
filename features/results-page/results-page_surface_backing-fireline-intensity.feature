@core
Feature: Surface Results - Backing Fireline Intensity

  @core
  Scenario: Backing Fireline Intensity is displayed in results when inputs are set
