@core
Feature: Surface Results - Heading Fireline Intensity

  @core
  Scenario: Heading Fireline Intensity is displayed in results when inputs are set
