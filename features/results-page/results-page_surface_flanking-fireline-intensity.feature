@core
Feature: Surface Results - Flanking Fireline Intensity

  @core
  Scenario: Flanking Fireline Intensity is displayed in results when inputs are set
