Feature: Crown & Surface Input - Fuel Model
  ...
  Scenario: Fuel Model is displayed when Fire Type is selected
    Given I have started a new Surface & Crown Worksheet in Guided Mode
    When these outputs are selected Submodule -> Group -> Output:
      """
  ...
  Scenario: Fuel Model is displayed when Transition Ratio is selected
    Given I have started a new Surface & Crown Worksheet in Guided Mode
    When these outputs are selected Submodule -> Group -> Output:
      """
  ...
  Scenario: Fuel Model is displayed when Critical Surface Flame Length is selected
    Given I have started a new Surface & Crown Worksheet in Guided Mode
    When these outputs are selected Submodule -> Group -> Output:
      """
  ...
  Scenario: Fuel Model is displayed when Critical Surface Fireline Intensity is selected
    Given I have started a new Surface & Crown Worksheet in Guided Mode
    When these outputs are selected Submodule -> Group -> Output:
      """
  ...
  Scenario: Fuel Model is displayed when Active Ratio is selected
    Given I have started a new Surface & Crown Worksheet in Guided Mode
    When these outputs are selected Submodule -> Group -> Output:
      """
  ...
  Scenario: Fuel Model is displayed when Critical Crown Rate of Spread is selected
    Given I have started a new Surface & Crown Worksheet in Guided Mode
    When these outputs are selected Submodule -> Group -> Output:
      """
