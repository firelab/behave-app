(ns mortality-conditionally-set-scorch-height
...
#_{:clj-kondo/ignore [:missing-docstring]}
(def species-master-table-keys
  [:species-code
   :scientific-name
   :common-name
   :mortality-equation-number
   :bark-equation-number
   :crown-coefficient-code
   :region-interior-west
   :region-pacifiic-west
   :region-north-east
   :region-south-east
   :equation-type
   :crown-damage-equation-code])

#_{:clj-kondo/ignore [:missing-docstring]}
(def species-master-table
  (map (fn [k v]
         (into {} (map vector k v)))
       (repeat species-master-table-keys) species-master-table-vals))

#_{:clj-kondo/ignore [:missing-docstring]}
(def crown-scorch-species (filter #(= (:equation-type %) :EquationType-crown_scorch) species-master-table))
