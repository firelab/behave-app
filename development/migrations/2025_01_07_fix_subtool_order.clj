(ns ^{:migrate/ignore? true} migrations.2025-01-07-fix-subtool-order
...
;; - Add missing order attribute on :subtool/variables
;; - Add units to getters for 1-HR Fuel Moisture tool
