...
SurfaceRunInDirectionOf EMSCRIPTEN_KEEPALIVE emscripten_enum_SurfaceRunInDirectionOf_HeadingFlankingBacking() {
  return SurfaceRunInDirectionOf::HeadingFlankingBacking;
}
