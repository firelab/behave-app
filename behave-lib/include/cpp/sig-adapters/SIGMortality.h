...
public:
    ...
    int  getCrownCoefficientCodeFromSpeciesCode(char* speciesCode) const; /* canopy cover equation #, (FVS Species Index No. )      */
    ...
    bool  checkIsInRegionFromSpeciesCode(char* speciesCode, RegionCode region) const;
...
private:
    void memberwiseCopyAssignment(const SIGMortality& rhs);
