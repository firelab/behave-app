...
void SIGFuelModels::memberwiseCopyAssignment(const SIGFuelModels& rhs)
{
...
void SIGFuelModels::initializeSingleFuelModelRecord(int fuelModelNumber)
{
...
void SIGFuelModels::initializeAllFuelModelRecords()
{
...
void SIGFuelModels::populateFuelModels()
{
...
bool SIGFuelModels::setCustomFuelModel(int fuelModelNumber, char* c_code, char* c_name,
    ...
    double savrLiveWoody, SurfaceAreaToVolumeUnits::SurfaceAreaToVolumeUnitsEnum savrUnits, bool isDynamic)
{
    ...
    {
         setFuelModelRecord(fuelModelNumber, SIGString::str2charptr(code), c_name,
...
bool SIGFuelModels::clearCustomFuelModel(int fuelModelNumber)
{
    bool successStatus = false;
...
void SIGFuelModels::markAsReservedModel(int fuelModelNumber)
{
    FuelModelArray_[fuelModelNumber].isReserved_ = true;
}

double SIGFuelModels::getFuelbedDepth(int fuelModelNumber, LengthUnits::LengthUnitsEnum lengthUnits) const
{
...
{
    return SIGString::str2charptr(FuelModelArray_[fuelModelNumber].code_);
}

char* SIGFuelModels::getFuelName(int fuelModelNumber) const
{
    return SIGString::str2charptr(FuelModelArray_[fuelModelNumber].name_);
}

double SIGFuelModels::getMoistureOfExtinctionDead(int fuelModelNumber, MoistureUnits::MoistureUnitsEnum moistureUnits) const
{
    return MoistureUnits::fromBaseUnits(FuelModelArray_[fuelModelNumber].moistureOfExtinctionDead_, moistureUnits);
}

double SIGFuelModels::getHeatOfCombustionDead(int fuelModelNumber, HeatOfCombustionUnits::HeatOfCombustionUnitsEnum heatOfCombustionUnits) const
{
    return HeatOfCombustionUnits::fromBaseUnits(FuelModelArray_[fuelModelNumber].heatOfCombustionDead_, heatOfCombustionUnits);
}

double SIGFuelModels::getHeatOfCombustionLive(int fuelModelNumber, HeatOfCombustionUnits::HeatOfCombustionUnitsEnum heatOfCombustionUnits) const
{
    return HeatOfCombustionUnits::fromBaseUnits(FuelModelArray_[fuelModelNumber].heatOfCombustionLive_, heatOfCombustionUnits);
}

double SIGFuelModels::getFuelLoadOneHour(int fuelModelNumber, LoadingUnits::LoadingUnitsEnum loadingUnits) const
{
    return LoadingUnits::fromBaseUnits(FuelModelArray_[fuelModelNumber].fuelLoadOneHour_, loadingUnits);
}

double SIGFuelModels::getFuelLoadTenHour(int fuelModelNumber, LoadingUnits::LoadingUnitsEnum loadingUnits) const
{
    return LoadingUnits::fromBaseUnits(FuelModelArray_[fuelModelNumber].fuelLoadTenHour_, loadingUnits);
}

double SIGFuelModels::getFuelLoadHundredHour(int fuelModelNumber, LoadingUnits::LoadingUnitsEnum loadingUnits) const
{
    return LoadingUnits::fromBaseUnits(FuelModelArray_[fuelModelNumber].fuelLoadHundredHour_, loadingUnits);
}

double SIGFuelModels::getFuelLoadLiveHerbaceous(int fuelModelNumber, LoadingUnits::LoadingUnitsEnum loadingUnits) const
{
    return LoadingUnits::fromBaseUnits(FuelModelArray_[fuelModelNumber].fuelLoadLiveHerbaceous_, loadingUnits);
}

double SIGFuelModels::getFuelLoadLiveWoody(int fuelModelNumber, LoadingUnits::LoadingUnitsEnum loadingUnits) const
{
    return LoadingUnits::fromBaseUnits(FuelModelArray_[fuelModelNumber].fuelLoadLiveWoody_, loadingUnits);
}

double SIGFuelModels::getSavrOneHour(int fuelModelNumber, SurfaceAreaToVolumeUnits::SurfaceAreaToVolumeUnitsEnum savrUnits) const
{
    return SurfaceAreaToVolumeUnits::fromBaseUnits(FuelModelArray_[fuelModelNumber].savrOneHour_, savrUnits);
}

double SIGFuelModels::getSavrLiveHerbaceous(int fuelModelNumber, SurfaceAreaToVolumeUnits::SurfaceAreaToVolumeUnitsEnum savrUnits) const
{
    return SurfaceAreaToVolumeUnits::fromBaseUnits(FuelModelArray_[fuelModelNumber].savrLiveHerbaceous_, savrUnits);
}

double SIGFuelModels::getSavrLiveWoody(int fuelModelNumber, SurfaceAreaToVolumeUnits::SurfaceAreaToVolumeUnitsEnum savrUnits) const
{
    return SurfaceAreaToVolumeUnits::fromBaseUnits(FuelModelArray_[fuelModelNumber].savrLiveWoody_, savrUnits);
}

bool SIGFuelModels::getIsDynamic(int fuelModelNumber) const
{
...
bool SIGFuelModels::isFuelModelDefined(int fuelModelNumber) const
{
    if (fuelModelNumber <= 0 || fuelModelNumber > 256)
    {
        return false;
...
bool SIGFuelModels::isFuelModelReserved(int fuelModelNumber) const
{
    if(fuelModelNumber <= 0 || fuelModelNumber > 256)
    {
        return false;
...
bool SIGFuelModels::isAllFuelLoadZero(int fuelModelNumber) const
{
