...
void SIGMortality::memberwiseCopyAssignment(const SIGMortality& rhs)
{
...
void SIGMortality::setRegion(RegionCode region)
{
    mortalityInputs_.setRegion(region);
}

void SIGMortality::setSpeciesCode(char* c_speciesCode)
{
    std::string speciesCode(c_speciesCode);
    ...
    {
        updateInputsForSpeciesCodeAndEquationType(c_speciesCode, equationType);
    }
}
...
void SIGMortality::setEquationType(EquationType equationType)
{
    ...
    if(speciesCode != "" && equationType != EquationType::not_set)
    {
        char* c_speciesCode = new char[speciesCode.length() + 1];
        std::strcpy(c_speciesCode, speciesCode.c_str());
        updateInputsForSpeciesCodeAndEquationType(c_speciesCode, equationType);
    }
}

void SIGMortality::setFlameLengthOrScorchHeightSwitch(FlameLengthOrScorchHeightSwitch flameLengthOrScorchHeightSwitch)
{
    mortalityInputs_.setFlameLengthOrScorchHeightSwitch(flameLengthOrScorchHeightSwitch);
}

void SIGMortality::setFlameLengthOrScorchHeightValue(double flameLengthOrScorchHeightValue, LengthUnits::LengthUnitsEnum flameLengthOrScorchHeightUnits)
{
    mortalityInputs_.setFlameLengthOrScorchHeightValue(flameLengthOrScorchHeightValue, flameLengthOrScorchHeightUnits);
}

void SIGMortality::setTreeDensityPerUnitArea(double numberOfTrees, AreaUnits::AreaUnitsEnum areaUnits)
{
...
void SIGMortality::setCrownDamage(double crownDamage)
{
    mortalityInputs_.setCrownDamage(crownDamage);
}

void SIGMortality::setCambiumKillRating(double cambiumKillRating)
{
    mortalityInputs_.setCambiumKillRating(cambiumKillRating);
}

void SIGMortality::setBeetleDamage(BeetleDamage beetleDamage)
{
...
void SIGMortality::setFireSeverity(FireSeverity fireSeverity)
{
    mortalityInputs_.setFireSeverity(fireSeverity);
}

RegionCode SIGMortality::getRegion() const
{
...
{
    return SIGString::str2charptr(mortalityInputs_.getSpeciesCode());
}
...
FlameLengthOrScorchHeightSwitch SIGMortality::getFlameLengthOrScorchHeightSwitch() const
{
    return mortalityInputs_.getFlameLengthOrScorchHeightSwitch();
}

double SIGMortality::getFlameLengthOrScorchHeightValue(LengthUnits::LengthUnitsEnum flameLengthOrScorchHeightUnits) const
{
    return mortalityInputs_.getFlameLengthOrScorchHeightValue(flameLengthOrScorchHeightUnits);
}

double SIGMortality::getTreeDensityPerUnitArea(AreaUnits::AreaUnitsEnum areaUnits) const
{
    return mortalityInputs_.getTreeDensityPerUnitArea(areaUnits);
}

double SIGMortality::getDBH(LengthUnits::LengthUnitsEnum diameterUnits) const
{
    return mortalityInputs_.getDBH(diameterUnits);
}

double SIGMortality::getTreeHeight(LengthUnits::LengthUnitsEnum treeHeightUnits) const
{
    return mortalityInputs_.getTreeHeight(treeHeightUnits);
}

double SIGMortality::getCrownRatio() const
{
    return mortalityInputs_.getCrownRatio();
}

double SIGMortality::getCrownDamage() const
{
    return mortalityInputs_.getCrownDamage();
}

CrownDamageEquationCode SIGMortality::getCrownDamageEquationCode() const
{
    return mortalityInputs_.getCrownDamageEquationCode();
}

CrownDamageType SIGMortality::getCrownDamageType() const
{
    return mortalityInputs_.getCrownDamageType();
}

double SIGMortality::getCambiumKillRating() const
{
    return mortalityInputs_.getCambiumKillRating();
}

BeetleDamage SIGMortality::getBeetleDamage() const
{
...
int SIGMortality::getCrownScorchOrBoleCharEquationNumber() const
{
    return mortalityInputs_.getCrownScorchOrBoleCharEquationNumber();
}

FireSeverity SIGMortality::getFireSeverity() const
{
    return mortalityInputs_.getFireSeverity();
}

double SIGMortality::getBarkThickness(LengthUnits::LengthUnitsEnum barkThicknessUnits) const
{
...
*******************************************************************************************************/
double SIGMortality::calculateMortality(ProbabilityUnits::ProbabilityUnitsEnum probablityUnits)
{
    initializeOutputs();
...
{
    return SIGString::str2charptr(speciesMasterTable_->record_[index].speciesCode_);
}

char* SIGMortality::getScientificNameAtSpeciesTableIndex(int index) const
{
    return SIGString::str2charptr(speciesMasterTable_->record_[index].scientificName_);
}

char* SIGMortality::getCommonNameAtSpeciesTableIndex(int index) const
{
    return SIGString::str2charptr(speciesMasterTable_->record_[index].commonName_);
}

int SIGMortality::getMortalityEquationNumberAtSpeciesTableIndex(int index) const
{
    return speciesMasterTable_->record_[index].mortalityEquationNumber_;
}

int SIGMortality::getBarkEquationNumberAtSpeciesTableIndex(int index) const
{
    return speciesMasterTable_->record_[index].barkEquationNumber_;
}

int SIGMortality::getCrownCoefficientCodeAtSpeciesTableIndex(int index) const
{
    return speciesMasterTable_->record_[index].crownCoefficientCode_;
}

EquationType SIGMortality::getEquationTypeAtSpeciesTableIndex(int index) const
{
    return speciesMasterTable_->record_[index].equationType_;
}

CrownDamageEquationCode SIGMortality::getCrownDamageEquationCodeAtSpeciesTableIndex(int index) const
{
    return speciesMasterTable_->record_[index].crownDamageEquationCode_;
}

bool SIGMortality::checkIsInRegionAtSpeciesTableIndex(int index, RegionCode region) const
{
...
bool SIGMortality::checkIsInRegionFromSpeciesCode(char* speciesCode, RegionCode region) const
{
    const int index = speciesMasterTable_->getSpeciesTableIndexFromSpeciesCode(speciesCode);
...
*******************************************************************************************************/
double  SIGMortality::calculateMortalityCrownScorch()
{
...
**********************************************************************************************************/
double  SIGMortality::Eq21_BlkHilPiPo(double treeHeight, double crownBaseHeight, double dbh, double scorch, double flameLength)
{
...
*******************************************************************************************************/
double SIGMortality::EngelmannSpruce(double cs)
{
    double f;
...
*  Ret: mortality probability 0 -> 1.0
*******************************************************************************************************/
double SIGMortality::WesternLarch(double cs, double dbh)
{
    double f;
...
*  Ret: mortality probability 0 -> 1.0
*******************************************************************************************************/
double SIGMortality::IncenseCedar(double cs)
{
    double f;
...
*  Ret: mortality probability 0 -> 1.0
*******************************************************************************************************/
double SIGMortality::SugarPine(double cs)
{
    double f;
...
*  Ret: mortality probability 0 -> 1.0
*******************************************************************************************************/
double SIGMortality::PonderosaJeffreyPine(double cs)
{
    double f;
...
*  Ret: mortality probability 0 -> 1.0
*******************************************************************************************************/
double SIGMortality::DouglasFir(double cs)
{
    double f;
...
*  Ret: mortality probability 0 -> 1.0
*******************************************************************************************************/
double SIGMortality::WhitebarkPine(double cs, double dbh)
{
    double f;
...
*  Ret: mortality probability 0 -> 1.0
*******************************************************************************************************/
double SIGMortality::RedFir(double cs)
{
    double f;
...
*  Ret: mortality probability 0 -> 1.0
*******************************************************************************************************/
double SIGMortality::SubalpineFir(double cs)
{
    double f;
...
*  Ret: mortality probability 0 -> 1.0
*******************************************************************************************************/
double SIGMortality::Whitefir(double cs)
{
    double f;
...
*******************************************************************************************************/
double SIGMortality::CC_Overlap(double SqFtCov)
{
    double x, p;
...
*******************************************************************************************************/
double SIGMortality::Basal_Area(double DBH, double Cnt)
{
    double f, r;
    r = DBH / 2; // radius 
...
// Ret: scorch height
*******************************************************************************************************/
double SIGMortality::Calc_Scorch(double flame)
{
    double f, g, h;
    f = flame / 0.45;
...
// Ret: flame length
*******************************************************************************************************/
double SIGMortality::Calc_Flame(double scorchHeight)
{
    double f, g;
...
*******************************************************************************************************/
void  SIGMortality::calculateMortalityTotals()
{
    double f;
...
*******************************************************************************************************/
void  SIGMortality::initializeOutputs()
{
...
*******************************************************************************************************/
double SIGMortality::PostFireInjuryCalculation()
{
...
*******************************************************************************************************/
bool SIGMortality::isValidInput()
{
    /*.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.- */
...
*  Ret:
*******************************************************************************************************/
double SIGMortality::Eq_WhiteFir_WF()
{
...
*  Ret: 1 ok
*******************************************************************************************************/
double SIGMortality::Eq_SubalpineFir_SF()
{
    double f, cs, ckr;
...
*  Out: mortalityInputs_->probability ...0 -> 1.0
*******************************************************************************************************/
double SIGMortality::Eq_WesternLarch_WL()
{
    double f, cs, ckr;
...
*  Ret: 1 ok
*******************************************************************************************************/
double SIGMortality::Eq_IncenseCedar_IC()
{
    double f, cs, ckr;
...
*
*******************************************************************************************************/
double SIGMortality::Eq_WhitebarkPine_WP()
{
    double f, cs, dbh, ckr;
    cs = mortalityInputs_.getCrownDamage();
    ckr = mortalityInputs_.getCambiumKillRating();
...
*  Out: mortalityInputs_->probability ...0 -> 1.0
*******************************************************************************************************/
double SIGMortality::Eq_EngelmannSpruce_ES()
{
    double f, cs, ckr;
    cs = mortalityInputs_.getCrownDamage();
    ckr = mortalityInputs_.getCambiumKillRating();
...
*  Out: mortalityInputs_->probability ...0 -> 1.0
*******************************************************************************************************/
double SIGMortality::Eq_RedFir_RF()
{
    double f, cs, ckr;
    cs = mortalityInputs_.getCrownDamage();
    ckr = mortalityInputs_.getCambiumKillRating();
...
*
*******************************************************************************************************/
double SIGMortality::Eq_SugarPine_SP()
{
...
*
*******************************************************************************************************/
double SIGMortality::Eq_PonderosaPine_PP()
{
...
*
*******************************************************************************************************/
double SIGMortality::Eq_PonderosaKill_PK()
{
    double f, crownDamage, ckr, beetleCoefficient, F;
...
*
*******************************************************************************************************/
double SIGMortality::Eq_DouglasFir_DF()
{
...
*
*******************************************************************************************************/
double SIGMortality::BoleCharCalculate()
{
    int i;
    double f;
...
* Ret: trees killed
*******************************************************************************************************/
double SIGMortality:: MIS_Killed()
{
...
// Ret: number
*******************************************************************************************************/
double SIGMortality::Squaredouble(double f)
{
    return f * f;
}
...
int SIGMortality::getNumberOfRecordsInSpeciesTable() const
{
    return (int)speciesMasterTable_->record_.size();
}

int SIGMortality::getSpeciesTableIndexFromSpeciesCodeAndEquationType(char* c_speciesNameCode, EquationType equationType) const
{
    std::string speciesNameCode(c_speciesNameCode);
    return speciesMasterTable_->getSpeciesTableIndexFromSpeciesCodeAndEquationType(speciesNameCode, equationType);
}

vector<bool> SIGMortality::getRequiredFieldVector()
{
...
SpeciesMasterTableRecord SIGMortality::getSpeciesRecordAtIndex(int index) const
{
...
std::vector<SpeciesMasterTableRecord> SIGMortality::getSpeciesRecordVectorForRegion(RegionCode region) const
{
...
std::vector<SpeciesMasterTableRecord> SIGMortality::getSpeciesRecordVectorForRegionAndEquationType(RegionCode region, EquationType equationType) const
{
    std::vector<SpeciesMasterTableRecord> speciesInSelectedRegion;
    bool isErroneousInput = false;
...
double SIGMortality::getProbabilityOfMortality(ProbabilityUnits::ProbabilityUnitsEnum probabilityUnits) const
{
    return ProbabilityUnits::fromBaseUnits(probabilityOfMortality_, probabilityUnits);
}

double SIGMortality::getTotalPrefireTrees() const
{
    return totalPrefireTrees_;
}

double SIGMortality::getKilledTrees() const
{
    return killedTrees_;
}

double SIGMortality::getBasalAreaPrefire() const
{
    return basalAreaPrefire_;
}

double SIGMortality::getBasalAreaKillled() const
{
    return basalAreaKillled_;
}

double SIGMortality::getBasalAreaPostfire() const
{
    return basalAreaPostfire_;
}

double SIGMortality::prefireCanopyCover() const
{
    return prefireCanopyCover_;
}

double SIGMortality::postfireCanopyCover() const
{
...
**************************************************************/
bool SIGMortality::updateInputsForSpeciesCodeAndEquationType(char* c_speciesCode, EquationType equationType)
{
    std::string speciesCode(c_speciesCode);
...
*      -1 if no equation
****************************************************************************/
double SIGMortality::calculateBarkThickness()
{
...
****************************************************************************/
double SIGMortality::calculateCrownCover()
{
